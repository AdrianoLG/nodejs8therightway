 ...
 * 1. Create a new bundle with the specified name
 * 2. Retrieve a given bundle
 * 3. Set the specified bundle's name with the specified name
 * 4. Put a book into a bundle by its id
 * 5. Delete a bundle entirely
 * 6. Remove a book from a bundle
 */
'use strict';
...
module.exports = (app, es) => {
    ...
    */
	app.post('/api/bundle', (req, res) => {
		...
		rp
			.post({ url, body: bundle, json: true })
